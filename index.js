...
// adjust-sourcemap-loader@4 is deliberately vendored. Its source-map codecs
// are part of resolve-url-loader's compatibility surface and keeping the exact
// processor here prevents an unrelated dependency release changing path
// decoding under existing webpack configurations.
const adjustSourceMap = require('./lib/vendor/adjust-sourcemap-loader/lib/process');
...
// Keep statically discoverable CommonJS properties for Node's ESM bridge.
// Object.assign above remains the compatibility mechanism and fixes property
// order; these assignments only make the same properties visible to tooling.
module.exports.asGenerator = joinFn.asGenerator;
module.exports.createJoinImplementation = joinFn.createJoinImplementation;
module.exports.createJoinFunction = joinFn.createJoinFunction;
module.exports.defaultJoinGenerator = joinFn.defaultJoinGenerator;
module.exports.defaultJoin = joinFn.defaultJoin;
